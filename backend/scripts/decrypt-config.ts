 ...
 */
const decryptConfig = (encryptedConfig: string): any => {
 ...
 */
const decryptTenantConfig = (tenantId: string): void => {
  try {
 ...
 */
const showTenantInfo = (tenantId: string): void => {
  try {
    const configPath = `configs/${tenantId}.enc`;
 ...
 */
const validateTenantConfig = (tenantId: string): void => {
  try {
    const configPath = `configs/${tenantId}.enc`;
