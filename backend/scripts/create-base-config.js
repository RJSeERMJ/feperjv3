...
const createBaseConfig = async () => {
    ...
    try {
        ...
        const baseConfig = {
            ...
            admin: {
                login: 'admin',
                passwordHash: await bcryptjs_1.default.hash('senha123', 12),
                name: 'Administrador',
                salt: await bcryptjs_1.default.genSalt(12),
...
`;
    fs_1.default.writeFileSync('configs/README.md', documentation);
...
//# sourceMappingURL=create-base-config.js.map